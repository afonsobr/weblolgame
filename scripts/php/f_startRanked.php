...
$rankedGameTime = 180; //Tempo de uma normal Game. Padrão: 600
        ...
        if ($playerLane == "Mid")
          {
            ...
            $player1 = $db->select("select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Top' and level=30 order by rand() limit 2");
            if ($player1)
              {
            ...
            $player2 = $db->select("select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Jungle' and level=30 order by rand() limit 2");
            if ($player2)
              {
            ...
            $player3 = $db->select("(select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Mid' and level=30 order by rand() limit 1)
            ...
            $player4 = $db->select("select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Sup' and level=30 order by rand() limit 2");
            if ($player4)
              {
            ...
            $player5 = $db->select("select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='ADC' and level=30 order by rand() limit 2");
            if ($player5)
              {
        ...
        else if ($playerLane == "ADC")
          {
            ...
            $player3 = $db->select("select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Mid' and level=30 order by rand() limit 2");
            if ($player3)
              {
                foreach ($player3 as $count)
                  {
            ...
            $player5 = $db->select("(select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='ADC' and level=30 order by rand() limit 1)
                union (select * from accounts where id = '" . $playerid . "')");
            if ($player5)
              {
                foreach ($player5 as $count)
        ...
        else if ($playerLane == "Sup")
          {
            ...
            $player4 = $db->select("(select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Sup' and level=30 order by rand() limit 1)
                union (select * from accounts where id = '" . $playerid . "')");
            if ($player4)
              {
                foreach ($player4 as $count)
        ...
        else if ($playerLane == "Top")
          {
            $i       = 0;
            $player1 = $db->select("(select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Top' and level=30 order by rand() limit 1)
                union (select * from accounts where id = '" . $playerid . "')");
            if ($player1)
              {
                foreach ($player1 as $count)
        ...
        else if ($playerLane == "Jungle")
          {
            ...
            $player2 = $db->select("(select * from accounts where 
                (status = 1 or status = 0) and (rank = '" . $playerRank . "' or rank = '" . ($playerRank + 1) . "') and id != '" . $playerid . "' and mainLane='Jungle' and level=30 order by rand() limit 1)
                union (select * from accounts where id = '" . $playerid . "')");
            if ($player2)
              {
                foreach ($player2 as $count)
